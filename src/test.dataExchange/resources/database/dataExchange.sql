...
--   mfp_per_30: Single MFP per 30 DES (currency, not nullable).
--   mfp_per_unit: MFP per Unit Price (currency, not nullable).
--   mfp_per_package: MFP per Package Price (currency, not nullable).
...
CREATE TABLE price_eff_dt (
    ...
    mfp_end_dt DATE,
    mfp_per_30 CURRENCY NOT NULL,
    mfp_per_unit CURRENCY NOT NULL,
    mfp_per_package CURRENCY NOT NULL,
...
VALUES ('2026', 'ELIQUIS', 'APIXABAN');

-- Insert data into price_ndc_cd
INSERT INTO price_ndc_cd (fk_price_ipay_name, ndc_cd)
VALUES (1, '00003-0893-21');

INSERT INTO price_ndc_cd (fk_price_ipay_name, ndc_cd)
VALUES (1, '00003-0893-31');

INSERT INTO price_ndc_cd (fk_price_ipay_name, ndc_cd)
VALUES (1, '00003-0893-41');
...
VALUES (1, #2026-01-01#, NULL, 231.00, 4.15, 248.70, #2024-08-15#, 'Added', 'Added alongside IPAY2026 MFP announcement');

INSERT INTO price_eff_dt (fk_price_ndc_cd, mfp_eff_dt, mfp_end_dt, mfp_per_30, mfp_per_unit, mfp_per_package, asof_dt, update_type, remark)
VALUES (2, #2026-01-01#, NULL, 231.00, 4.15, 414.51, #2024-08-15#, 'Added', 'Added alongside IPAY2026 MFP announcement');

INSERT INTO price_eff_dt (fk_price_ndc_cd, mfp_eff_dt, mfp_end_dt, mfp_per_30, mfp_per_unit, mfp_per_package, asof_dt, update_type, remark)
VALUES (3, #2026-01-01#, NULL, 231.00, 4.15, 746.11, #2024-08-15#, 'Added', 'Added alongside IPAY2026 MFP announcement');
