...
public class RestImpl {
    ...
    private String baseUrl = YamlReader.getYamlProperties(System.getProperty("projectName"), System.getProperty("env"),"baseUrl");  // Example base URL, should be parameterized or configurable.
